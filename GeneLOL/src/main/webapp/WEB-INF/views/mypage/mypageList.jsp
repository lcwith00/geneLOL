...
<body>
	...
	<div id="mypage">
		...
		<c:forEach var="board" items="${mypageList}">
		<div class="ui three column grid" id="boardpage2">
			<div class="one wide column"></div>
			<div class="three wide column">
				<a href="http://www.naver.com">${board.board_title}</a>
			</div>
			<div class="two wide column">${board.board_recomm}</div>
			<div class="two wide column">${board.board_content}</div>
			<div class="two wide column">
				<fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss"
					value="${board.board_date}"/>
				작성일
			</div>
			<div class="two wide column">${board.board_count}</div>
			<div class="three wide column">
